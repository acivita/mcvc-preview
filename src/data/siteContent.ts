...
export const partnerBrands = [
  ...
  },
  {
    ...
    logo: "/assets/brands/mitsubishi-electric.svg",
  },
  {
    name: "Daikin",
    logo: "/assets/brands/daikin.svg",
  },
  {
    name: "Toshiba",
    logo: "/assets/brands/toshiba.svg",
  },
  {
    name: "Panasonic",
    logo: "/assets/brands/panasonic.svg",
  },
];
...
export const googleReviews = [
  {
    ...
    text: "Je recommande à 100 % cette entreprise pour son professionnalisme, sa rapidité, la qualité du service et la gentillesse de ses employés.",
  },
  {
    ...
    stars: "★★★★★",
    publishedAt: "2026-05-13",
    text: "Cela fait de nombreuses fois que nous faisons appel à Mickael, dynamique, à l’écoute et très professionnel. Il est un spécialiste dans son secteur que je recommande vivement !",
  },
  {
    ...
    text: "Installation de chauffage parfaite ! Travail très professionnel du début à la fin. Les conseils avant l’installation étaient clairs, le matériel de qualité et la pose soignée. Respect des délais, chantier propre et fonctionnement impeccable.",
  },
  {
    author: "Tom Gosse",
    rating: 5,
    stars: "★★★★★",
    publishedAt: "2026-04-20",
    text: "Nous avons fait appel à ce plombier chauffagiste pour l’installation d’une climatisation dans deux chambres de notre appartement. Intervention rapide, travail propre, soigné et réalisé avec beaucoup de professionnalisme. Communication simple, claire et réactive du début à la fin.",
  },
  {
    ...
    stars: "★★★★★",
    publishedAt: "2026-04-20",
    text: "Excellent professionnel, intervient très rapidement de façon satisfaisante. Excellent travail.",
  },
];
